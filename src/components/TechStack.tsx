...
export default function TechStack() {
  ...
  return (
    <section className="relative py-14 md:py-28 overflow-hidden bg-white dark:bg-[#030014]/40" id="tech-stack">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8 md:mb-16 max-w-4xl mx-auto relative z-10 select-none">
          {categories.map((cat) => (
            <button
              key={cat}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {techMap[activeCategory].map((tech) => (
              <div
                key={tech.name}
                className="p-6 rounded-2xl glass border border-slate-200/50 dark:border-slate-800/80 hover:border-brand-purple/20 transition-all duration-300 flex items-center justify-between group cursor-pointer"
              >
